...
import static com.github.courtandrey.cinegraph.exporter.jooq.Tables.DIRTY_SCOPE;
import static com.github.courtandrey.cinegraph.exporter.jooq.Tables.EDGE;
import static com.github.courtandrey.cinegraph.exporter.jooq.Tables.EDGE_CREW;
import static com.github.courtandrey.cinegraph.exporter.jooq.Tables.EDGE_CREW_TMP;
...
import static com.github.courtandrey.cinegraph.exporter.jooq.Tables.SCORED_CREDIT;
...
public class EdgeBuildService {
    ...
    private Table<?> genreLateral(com.github.courtandrey.cinegraph.exporter.jooq.tables.EdgeCrew ec) {
    ...
    private Table<?> keywordLateral(com.github.courtandrey.cinegraph.exporter.jooq.tables.EdgeCrew ec) {
    ...
    private Table<?> dateLateral(com.github.courtandrey.cinegraph.exporter.jooq.tables.EdgeCrew ec) {
        var ma = MOVIE.as("ma");
        var mb = MOVIE.as("mb");
